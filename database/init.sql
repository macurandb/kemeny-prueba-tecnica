...
INSERT INTO tags (id, name, color) VALUES
    ('fab11111-1111-1111-1111-111111111111', 'backend', '#3B82F6'),
    ('fab22222-2222-2222-2222-222222222222', 'frontend', '#8B5CF6'),
    ('fab33333-3333-3333-3333-333333333333', 'bug', '#EF4444'),
    ('fab44444-4444-4444-4444-444444444444', 'feature', '#10B981'),
    ('fab55555-5555-5555-5555-555555555555', 'devops', '#F59E0B'),
    ('fab66666-6666-6666-6666-666666666666', 'security', '#EC4899'),
    ('fab77777-7777-7777-7777-777777777777', 'performance', '#06B6D4'),
    ('fab88888-8888-8888-8888-888888888888', 'documentation', '#6B7280');

-- Task Tags (some tasks already have manual tags)
INSERT INTO task_tags (task_id, tag_id, assigned_by) VALUES
    ('11111111-1111-1111-1111-111111111111', 'fab11111-1111-1111-1111-111111111111', 'manual'),
    ('11111111-1111-1111-1111-111111111111', 'fab66666-6666-6666-6666-666666666666', 'manual'),
    ('22222222-2222-2222-2222-222222222222', 'fab33333-3333-3333-3333-333333333333', 'manual'),
    ('22222222-2222-2222-2222-222222222222', 'fab22222-2222-2222-2222-222222222222', 'manual'),
    ('33333333-3333-3333-3333-333333333333', 'fab22222-2222-2222-2222-222222222222', 'manual'),
    ('44444444-4444-4444-4444-444444444444', 'fab11111-1111-1111-1111-111111111111', 'manual'),
    ('66666666-6666-6666-6666-666666666666', 'fab77777-7777-7777-7777-777777777777', 'manual'),
    ('66666666-6666-6666-6666-666666666666', 'fab11111-1111-1111-1111-111111111111', 'manual'),
    ('77777777-7777-7777-7777-777777777777', 'fab55555-5555-5555-5555-555555555555', 'manual'),
    ('88888888-8888-8888-8888-888888888888', 'fab44444-4444-4444-4444-444444444444', 'manual');
